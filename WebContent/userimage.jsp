		...
		<div class="row main">
			...
			<div class="f-12 main-content">
				...
				<div class="user-content">
					<form action="UpdateUserImageServlet" enctype="multipart/form-data" method="post">
						<input type="text" name="user_id" value="<%=user_id %>"  hidden>
						<div class="user-header">
							<img src="<%=session.getAttribute("image_link") %>" width="36" height="36" alt="">
							<div class="upload">上传头像:<input type="file" name="userpic"></div>
						</div>
