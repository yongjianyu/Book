...
<body>
	...
	<form action="UpdateServlet" method="post">
		...
		<br>
		价格:<input type="text" name="price" value="<%=map.get("book_price") %>">
		<br>
		数量:<input type="text" name="count" value="<%=map.get("book_count") %>">
		<br>
		作者:<input type="text" name="author" value="<%=map.get("book_author") %>">
		<br>
